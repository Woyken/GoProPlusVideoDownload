 ...
 * @param id
 */
export async function getDownloadUrl(id: string, capturedAtStr: string) {
    ...
    const response = await fetch(`https://api.gopro.com/media/${id}/download`); //GoProItemDownloadResponseData
